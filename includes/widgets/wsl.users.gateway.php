		...
		else
		{
			...
			*/
			...
			if( $change_username == 1 )
			{
				...
				{
					$profile_completion_errors[] = _wsl__( '<strong>ERROR</strong>: Sorry, that username already exists! Your email from social account not match with this account email', 'wordpress-social-login' );
				}
			}
			# }}} validate username
